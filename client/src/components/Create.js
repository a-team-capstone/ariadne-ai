      ...
      <div className="create-maze">
        <h3>Get Creative</h3>
        {
          ...
          <Fragment>
            ...
            <div className="key">
              <img src='/shield.png'/><p>STA - Start</p>
              <img src='/star.png'/><p>END - End</p>
              <img src='/hourGlassYellow.png'/><p>XTM - Extra time</p>
              <img src='/bomb.png'/><p>BMB - Bomb</p>
              <img src='/freeze.png'/><p>FRZ - Freeze</p>
              <img src='/tele.png'/><p>TEL - Tele</p>
              <img src='/port.png'/><p>PRT - port</p>
            </div>
